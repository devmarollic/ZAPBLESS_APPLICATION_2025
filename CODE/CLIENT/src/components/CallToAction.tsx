                    ...
                    <div className="md:grid md:grid-cols-2">
                        <div className="p-8 md:p-12 text-white">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button
                                    className="bg-white text-zapPurple-600 hover:bg-gray-100 rounded-full px-8 py-6"
                                ...
                                <Button
                                    variant="outline"
                                    className="border-white text-white bg-white/10 rounded-full px-8 py-6 z-10"
                                    onClick={() => {
